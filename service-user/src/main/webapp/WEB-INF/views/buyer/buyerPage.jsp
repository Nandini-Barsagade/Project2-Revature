	...
	<nav class="navbar navbar-expand-lg navbar-dark"
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<!-- Link to Profile (Email will be shown here) -->
				<!-- <li class="nav-item"><a id="profile-link" class="nav-link"
					href="#"> <i class="fas fa-user"></i> Profile
				</a></li> -->
				...
				<div class="col-md-4">
					<div class="product-card">
						...
						<div class="action-buttons">
							<%-- <a href="/addToWishlist/${product.id}" class="btn-wishlist">Add
								to Wishlist</a> --%>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(users) {
                    if (users.length > 0) {
                        // Assuming you want the first user's email to be displayed
